        ...
        <div className="searchBar">
            ...
            {!hideButtons ? (
                <div className="searchButton">
                    <input id="subBut" type="submit" onClick={search} value="Findstr Search"></input>
                    
                </div>
            ): (
                <div className="searchButton">
                    <input className="searchButton__hidden" type="submit" onClick={search} value="Findstr Search"></input>
                    <input className="searchButton__hidden" type="button" value=" Felling Lucky"></input>
                </div>
            )}
            </form>
        </div>
